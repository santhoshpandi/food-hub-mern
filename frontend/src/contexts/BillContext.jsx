...
export function BillProvider({ children }) {
  ...
  async function  showBillData() {
    try{
      const response = await axios.get(`${import.meta.env.VITE_APP_API_URI}/api/bill/`,{
  ...
  async function  deleteBillData(id) {
    try{
      const response = await axios.delete(`${import.meta.env.VITE_APP_API_URI}/api/bill/${id}`,{
        withCredentials:true
      })
      if(response.data.success){        
  ...
  async function submitData(billData) {     
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_APP_API_URI}/api/bill/`, billData,{
